      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="card p-6 space-y-4">
          <div>
            ...
            <input value={name} onChange={e=>setName(e.target.value)} className="w-full bg-gray-800 border border-gray-700 rounded-lg p-3" placeholder="Your display name" />
          </div>
          <div>
          ...
          <p className="text-sm text-gray-400">Already have an account? <Link href="/signin" className="text-blue-400 hover:underline">Sign in</Link></p>
        </div>
